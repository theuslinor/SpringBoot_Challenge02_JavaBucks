...
VALUES
    ...
    (106, '70707-070', 6006, 'Estrada Modelo 6');
...
VALUES
    ...
    (6, 'Descrição do Produto 6', 'Produto 6', 10, 222.99);
...
VALUES
    ...
    (NULL, NULL, '2022-10-21 09:00:00.234', 8.00, 'CRYPTOCURRENCY', 'CONFIRMED', 40.00, 32.00, 104, 4),
    (NULL, NULL, '2023-10-22 16:20:00.567', 12.00, 'GIFT_CARD', 'CONFIRMED', 60.00, 48.00, 105, 5),
    (NULL, NULL, '2022-10-22 16:20:00.567', 12.00, 'PIX', 'CONFIRMED', 60.00, 48.00, 106, 6);
