...
public class ProductConstants {
    ...
    public static final Product PRODUCT = new Product("name", 99.0, "description with more 10 caracters");
    public static final Product INVALID_PRODUCT = new Product("", -1.0, "");
